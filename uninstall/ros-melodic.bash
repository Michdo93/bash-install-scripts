...
run_command "apt-get remove --auto-remove ros-melodic-desktop-full" "$sudo_available"
...
run_command "sed -i '/source \/opt\/ros\/melodic\/setup.bash/d' $HOME/.bashrc" "$sudo_available"
