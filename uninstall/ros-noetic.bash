...
run_command "apt-get remove --auto-remove ros-noetic-desktop-full" "$sudo_available"
...
run_command "apt-key del C1CF6E31E6BADE8868B172B4F42ED6FBAB17C654" "$sudo_available"
...
run_command "sed -i '/source \/opt\/ros\/noetic\/setup.bash/d' $HOME/.bashrc" "$sudo_available"
