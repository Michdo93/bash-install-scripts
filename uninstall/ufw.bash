...
# Deaktivieren und Löschen der UFW-Konfiguration
run_command "ufw disable" "$sudo_available"
run_command "ufw --force reset" "$sudo_available"

run_command "apt purge --autoremove ufw -y" "$sudo_available"
