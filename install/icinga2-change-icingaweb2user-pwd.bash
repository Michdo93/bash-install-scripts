...
# Benutzer auffordern, das neue Passwort für icingaweb2user einzugeben
read -sp "Geben Sie das neue Passwort für 'icingaweb2user' ein: " new_password
echo
...
mariadb_commands="
ALTER USER 'icingaweb2user'@'localhost' IDENTIFIED BY '$new_password';
FLUSH PRIVILEGES;
EXIT;
"
