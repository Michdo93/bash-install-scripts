...
# Compose-Datei
compose_file="$config_dir/plex-meta-manager.yml"

# Service-Datei
service_file="/etc/systemd/system/plex-meta-manager.service"
...
# Überprüfen, ob Plex Meta Manager bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^plex-meta-manager$"; then
    echo "Plex Meta Manager ist bereits installiert."
else
    # Plex Meta Manager Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die Docker Compose-Datei für Plex Meta Manager wurde erstellt."
        echo "Plex Meta Manager wird auf Port $available_port gestartet."
    fi
fi
...
sudo systemctl enable plex-meta-manager.service
