...
# Compose-Datei
compose_file="$config_dir/habridge.yml"

# Service-Datei
service_file="/etc/systemd/system/habridge.service"
...
run_command "mkdir -p $container_dir/habridge/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für HaBridge erstellt."
else
