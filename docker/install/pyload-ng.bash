...
# Compose-Datei
compose_file="$config_dir/pyload-ng.yml"

# Service-Datei
service_file="/etc/systemd/system/pyload-ng.service"
...
# Überprüfen, ob Pyload-NG bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^pyload-ng$"; then
    echo "Pyload-NG ist bereits installiert."
else
    # Pyload-NG Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Pyload-NG Docker Compose-Datei erstellt."
    fi
fi
...
sudo systemctl enable pyload-ng.service
sudo systemctl start pyload-ng.service