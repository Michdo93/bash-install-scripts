...
# Compose-Datei
compose_file="$config_dir/tvheadend.yml"

# Service-Datei
service_file="/etc/systemd/system/tvheadend.service"
...
# Überprüfen, ob TVHeadend bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^tvheadend$"; then
    echo "TVHeadend ist bereits installiert."
else
    # TVHeadend Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die TVHeadend Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für TVHeadend existiert bereits: $compose_file"
    fi
fi
