...
services:
  booksonic-air:
    ...
    volumes:
      ...
      - /path/to/booksonic-air/audiobooks:/audiobooks
      - /path/to/booksonic-air/podcasts:/podcasts
      - /path/to/booksonic-air/othermedia:/othermedia
    ports:
      - "$available_port:4040"
    restart: unless-stopped
EOL

    echo "Booksonic Air Docker Compose-Datei erstellt."
fi
