...
# Compose-Datei
compose_file="$config_dir/series-troxide.yml"

# Service-Datei
service_file="/etc/systemd/system/series-troxide.service"
...
# Überprüfen, ob series-troxide bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^series-troxide$"; then
    echo "series-troxide ist bereits installiert."
else
    # series-troxide Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die series-troxide Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für series-troxide existiert bereits: $compose_file"
    fi
fi
...
sudo systemctl enable series-troxide.service
sudo systemctl start series-troxide.service