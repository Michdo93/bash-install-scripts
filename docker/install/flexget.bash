...
# Compose-Datei
compose_file="$config_dir/flexget.yml"

# Service-Datei
service_file="/etc/systemd/system/flexget.service"
...
run_command "mkdir -p $container_dir/flexget/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für FlexGet erstellt."
else
