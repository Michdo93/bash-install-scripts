...
# Compose-Datei
compose_file="$config_dir/github-desktop.yml"

# Service-Datei
service_file="/etc/systemd/system/github-desktop.service"
...
run_command "mkdir -p $container_dir/github-desktop/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für GitHub Desktop erstellt."
else
...
sudo systemctl enable github-desktop.service
sudo systemctl start github-desktop.service
