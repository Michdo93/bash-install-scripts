...
compose_file="$config_dir/kimai.yml"
...
service_file="/etc/systemd/system/kimai.service"
cat > "$service_file" <<EOL
[Unit]
Description=Kimai Setup
...
sudo systemctl enable kimai.service
sudo systemctl start kimai.service

echo "Kimai und MariaDB wurden installiert und gestartet."
