...
# Compose-Datei
compose_file="$config_dir/hedgedoc.yml"

# Service-Datei
service_file="/etc/systemd/system/hedgedoc.service"
...
run_command "mkdir -p $container_dir/hedgedoc/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für HedgeDoc erstellt."
else
