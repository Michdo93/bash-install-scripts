...
compose_file="$config_dir/lychee.yml"
...
services:
  lychee:
    ...
    volumes:
      - $container_dir/lychee/config:/config
...
service_file="/etc/systemd/system/lychee.service"
...
sudo systemctl enable lychee.service
sudo systemctl start lychee.service

echo "Lychee wurde installiert und gestartet."
