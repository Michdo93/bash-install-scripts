...
compose_file="$config_dir/medusa.yml"
...
EOL
    ...
    echo "Docker Compose-Datei für Medusa erstellt."
else
    echo "Die Docker Compose-Datei für Medusa existiert bereits."
fi
...
service_file="/etc/systemd/system/medusa-setup.service"
cat > "$service_file" <<EOL
[Unit]
Description=Medusa Setup
...
sudo systemctl enable medusa-setup.service
sudo systemctl start medusa-setup.service

echo "Medusa wurde installiert und eingerichtet."
