...
# Überprüfen, ob NZBHydra2 bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^nzbhydra2$"; then
...
services:
  nzbhydra2:
    ...
    environment:
      ...
      - TZ=Etc/UTC
    volumes:
      - $container_dir/nzbhydra2/config:/config
...
EOL
        ...
        echo "NZBHydra2 Docker Compose-Datei erstellt."
    else
        echo "Die NZBHydra2 Docker Compose-Datei existiert bereits."
    fi
...
EOL
    ...
    sudo systemctl enable nzbhydra2-setup.service
    sudo systemctl start nzbhydra2-setup.service
fi
