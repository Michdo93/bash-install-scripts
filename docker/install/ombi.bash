...
# Überprüfen, ob Ombi bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^ombi$"; then
...
EOL
        ...
        echo "Ombi Docker Compose-Datei erstellt."
    else
        echo "Die Ombi Docker Compose-Datei existiert bereits."
    fi
...
EOL
    ...
    sudo systemctl enable ombi-setup.service
    sudo systemctl start ombi-setup.service
fi
