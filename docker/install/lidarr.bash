...
compose_file="$config_dir/lidarr.yml"
if [ ! -f "$compose_file" ]; then
    # Einen verfügbaren Port finden
    available_port=$(find_next_port 8686)
...
service_file="/etc/systemd/system/lidarr.service"
cat > "$service_file" <<EOL
[Unit]
Description=Lidarr Setup
...
echo "Lidarr wurde installiert und gestartet."
