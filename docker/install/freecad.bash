...
# Compose-Datei
compose_file="$config_dir/freecad.yml"

# Service-Datei
service_file="/etc/systemd/system/freecad.service"
...
run_command "mkdir -p $container_dir/freecad/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für FreeCAD erstellt."
else
...
sudo systemctl enable freecad.service
sudo systemctl start freecad.service
