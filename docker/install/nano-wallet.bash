...
# Compose-Datei
compose_file="$config_dir/nano-wallet.yml"

# Service-Datei
service_file="/etc/systemd/system/nano-wallet-setup.service"
...
EOL
    ...
    echo "Docker Compose-Datei für Nano Wallet erstellt."
else
    echo "Die Docker Compose-Datei für Nano Wallet existiert bereits."
fi
...
sudo systemctl enable nano-wallet-setup.service
sudo systemctl start nano-wallet-setup.service

echo "Nano Wallet wurde installiert und eingerichtet."
