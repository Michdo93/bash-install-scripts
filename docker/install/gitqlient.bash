...
# Compose-Datei
compose_file="$config_dir/gitqlient.yml"

# Service-Datei
service_file="/etc/systemd/system/gitqlient.service"
...
run_command "mkdir -p $container_dir/gitqlient/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für GitQlient erstellt."
else
...
sudo systemctl enable gitqlient.service
sudo systemctl start gitqlient.service
