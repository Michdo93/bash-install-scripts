...
compose_file="$config_dir/netbox.yml"
...
services:
  netbox:
    ...
    volumes:
      - $container_dir/netbox:/config
    ports:
      - 8000:8000
    restart: unless-stopped
EOL

    echo "Docker Compose-Datei für Netbox erstellt."
else
    echo "Die Docker Compose-Datei für Netbox existiert bereits."
fi
...
service_file="/etc/systemd/system/netbox-setup.service"
cat > "$service_file" <<EOL
[Unit]
Description=Netbox Setup
...
sudo systemctl enable netbox-setup.service
sudo systemctl start netbox-setup.service

echo "Netbox wurde installiert und eingerichtet."
