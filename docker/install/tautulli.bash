...
# Überprüfen, ob Tautulli bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^tautulli$"; then
...
EOL
        ...
        echo "Die Tautulli Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für Tautulli existiert bereits: $compose_file"
    fi
fi
