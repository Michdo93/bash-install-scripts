...
# Service-Datei
service_file="/etc/systemd/system/transmission.service"
...
# Überprüfen, ob Transmission bereits installiert ist
...
EOL
        ...
        echo "Die Transmission Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für Transmission existiert bereits: $compose_file"
    fi
fi
