...
# Compose-Datei
compose_file="$config_dir/sickgear.yml"

# Service-Datei
service_file="/etc/systemd/system/sickgear.service"
...
# Überprüfen, ob SickGear bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^sickgear$"; then
    echo "SickGear ist bereits installiert."
else
    # SickGear Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die SickGear Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für SickGear existiert bereits: $compose_file"
    fi
