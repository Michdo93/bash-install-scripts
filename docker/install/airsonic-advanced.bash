...
run_command "mkdir -p $container_dir/airsonic-advanced/config" "$sudo_available"
run_command "mkdir -p $container_dir/airsonic-advanced/music" "$sudo_available"
run_command "mkdir -p $container_dir/airsonic-advanced/playlists" "$sudo_available"
run_command "mkdir -p $container_dir/airsonic-advanced/podcasts" "$sudo_available"
run_command "mkdir -p $container_dir/airsonic-advanced/other_media" "$sudo_available"
...
services:
  airsonic-advanced:
    ...
    volumes:
      ...
      - $container_dir/airsonic-advanced/music:/music
      - $container_dir/airsonic-advanced/playlists:/playlists
      - $container_dir/airsonic-advanced/podcasts:/podcasts
      - $container_dir/airsonic-advanced/other_media:/media
    ports:
      - "$available_port:4040"
    devices:
      - /dev/snd:/dev/snd
