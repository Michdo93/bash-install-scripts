...
compose_file="$config_dir/libreoffice.yml"
...
services:
  libreoffice:
    ...
    environment:
      ...
      - TZ=Etc/UTC
    volumes:
      - $container_dir/libreoffice/config:/config
    ports:
      - "$available_port:3000"
      - "3001:3001"
...
service_file="/etc/systemd/system/libreoffice.service"
...
echo "LibreOffice wurde installiert und gestartet."
