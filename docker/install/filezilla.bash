...
# Compose-Datei
compose_file="$config_dir/filezilla.yml"

# Service-Datei
service_file="/etc/systemd/system/filezilla.service"
...
run_command "mkdir -p $container_dir/filezilla/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für FileZilla erstellt."
else
...
sudo systemctl enable filezilla.service
sudo systemctl start filezilla.service
