...
# Compose-Datei
compose_file="$config_dir/foldingathome.yml"

# Service-Datei
service_file="/etc/systemd/system/foldingathome.service"
...
run_command "mkdir -p $container_dir/foldingathome/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für Folding@home erstellt."
else
