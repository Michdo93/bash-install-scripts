...
compose_file="$config_dir/nginx.yml"
...
services:
  nginx:
    ...
    environment:
      ...
      - TZ=Etc/UTC
    volumes:
      - $container_dir/nginx/config:/config
    ports:
      - 80:80
      - 443:443
...
EOL
    ...
    echo "Docker Compose-Datei für Nginx erstellt."
else
    echo "Die Docker Compose-Datei für Nginx existiert bereits."
fi
...
service_file="/etc/systemd/system/nginx-setup.service"
...
echo "Nginx wurde installiert und eingerichtet."
