...
# Compose-Datei
compose_file="$config_dir/mylar3.yml"

# Service-Datei
service_file="/etc/systemd/system/mylar3-setup.service"
...
services:
  mylar3:
    ...
    environment:
      ...
      - TZ=Etc/UTC
    volumes:
      - $container_dir/mylar3/config:/config
...
EOL
    ...
    echo "Docker Compose-Datei für Mylar3 erstellt."
else
    echo "Die Docker Compose-Datei für Mylar3 existiert bereits."
fi
...
sudo systemctl enable mylar3-setup.service
sudo systemctl start mylar3-setup.service

echo "Mylar3 wurde installiert und eingerichtet."
