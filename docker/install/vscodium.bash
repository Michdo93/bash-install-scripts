...
# Compose-Datei
compose_file="$config_dir/vscodium.yml"

# Service-Datei
service_file="/etc/systemd/system/vscodium.service"
...
# Überprüfen, ob VSCodium bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^vscodium$"; then
    echo "VSCodium ist bereits installiert."
else
    # VSCodium Docker Compose-Datei erstellen
