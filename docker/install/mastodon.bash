...
compose_file="$config_dir/mastodon.yml"
...
services:
  mastodon:
    ...
    environment:
      ...
      - NO_CHOWN= #optional
    volumes:
      - $container_dir/mastodon/config:/config
    ports:
      - 80:80
      - 443:443
...
EOL
    ...
    echo "Docker Compose-Datei für Mastodon erstellt."
else
    echo "Die Docker Compose-Datei für Mastodon existiert bereits."
fi
...
service_file="/etc/systemd/system/mastodon.service"
...
echo "Mastodon wurde installiert und gestartet."
