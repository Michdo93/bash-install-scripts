...
# Compose-Datei
compose_file="$config_dir/freshrss.yml"

# Service-Datei
service_file="/etc/systemd/system/freshrss.service"
...
run_command "mkdir -p $container_dir/freshrss/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für FreshRSS erstellt."
else
