...
# Compose-Datei
compose_file="$config_dir/heimdall.yml"

# Service-Datei
service_file="/etc/systemd/system/heimdall-setup.service"
...
run_command "mkdir -p $container_dir/heimdall/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für Heimdall erstellt."
else
...
sudo systemctl enable heimdall-setup.service
sudo systemctl start heimdall-setup.service
