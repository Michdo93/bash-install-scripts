...
# Compose-Datei
compose_file="$config_dir/piwigo.yml"

# Service-Datei
service_file="/etc/systemd/system/piwigo.service"
...
# Überprüfen, ob Piwigo bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^piwigo$"; then
    echo "Piwigo ist bereits installiert."
else
    # Piwigo Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Piwigo Docker Compose-Datei erstellt."
    else
        echo "Die Piwigo Docker Compose-Datei existiert bereits."
    fi
fi
...
sudo systemctl enable piwigo.service
