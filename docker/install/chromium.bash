...
# Compose-Datei
compose_file="$config_dir/chromium.yml"

# Service-Datei
service_file="/etc/systemd/system/chromium.service"
...
run_command "mkdir -p $container_dir/chromium/config" "$sudo_available"
...
# Überprüfen, ob Chromium bereits installiert ist
...
services:
  chromium:
    ...
    volumes:
      - $container_dir/chromium/config:/config
    ports:
      - "$port1:3000"
      - "$port2:3001"
    shm_size: "1gb"
