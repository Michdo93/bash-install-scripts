...
compose_file="$config_dir/nano.yml"
...
EOL
    ...
    echo "Docker Compose-Datei für Nano erstellt."
else
    echo "Die Docker Compose-Datei für Nano existiert bereits."
fi
...
service_file="/etc/systemd/system/nano-setup.service"
cat > "$service_file" <<EOL
[Unit]
Description=Nano Setup
...
sudo systemctl enable nano-setup.service
sudo systemctl start nano-setup.service

echo "Nano wurde installiert und eingerichtet."
