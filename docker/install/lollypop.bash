...
compose_file="$config_dir/lollypop.yml"
...
services:
  lollypop:
    ...
    environment:
      ...
      - TZ=Etc/UTC
    volumes:
      - $container_dir/lollypop/config:/config
    ports:
      - "$available_port:3000"
...
service_file="/etc/systemd/system/lollypop.service"
cat > "$service_file" <<EOL
[Unit]
Description=Lollypop Setup
...
sudo systemctl enable lollypop.service
sudo systemctl start lollypop.service

echo "Lollypop wurde installiert und gestartet."
