...
# Compose-Datei
compose_file="$config_dir/sonarr.yml"
...
# Überprüfen, ob Sonarr bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^sonarr$"; then
    echo "Sonarr ist bereits installiert."
else
    # Sonarr Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die Sonarr Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für Sonarr existiert bereits: $compose_file"
    fi
fi
