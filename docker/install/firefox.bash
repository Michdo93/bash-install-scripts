...
# Compose-Datei
compose_file="$config_dir/firefox.yml"

# Service-Datei
service_file="/etc/systemd/system/firefox.service"
...
run_command "mkdir -p $container_dir/firefox/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für Firefox erstellt."
else
