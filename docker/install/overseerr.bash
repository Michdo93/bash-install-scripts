...
# Überprüfen, ob Overseerr bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^overseerr$"; then
...
EOL
        ...
        echo "Overseerr Docker Compose-Datei erstellt."
    else
        echo "Die Overseerr Docker Compose-Datei existiert bereits."
    fi
...
EOL
    ...
    sudo systemctl enable overseerr-setup.service
    sudo systemctl start overseerr-setup.service
fi
