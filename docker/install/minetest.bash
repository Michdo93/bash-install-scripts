...
compose_file="$config_dir/minetest.yml"
...
services:
  minetest:
    ...
    volumes:
      - $container_dir/minetest/config:/config/.minetest
    ports:
      - 30000:30000/udp
    restart: unless-stopped
EOL

    echo "Docker Compose-Datei für Minetest erstellt."
else
    echo "Die Docker Compose-Datei für Minetest existiert bereits."
fi
...
service_file="/etc/systemd/system/minetest-setup.service"
cat > "$service_file" <<EOL
[Unit]
Description=Minetest Setup
...
sudo systemctl enable minetest-setup.service
sudo systemctl start minetest-setup.service

echo "Minetest wurde installiert und eingerichtet."
