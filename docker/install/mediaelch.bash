...
compose_file="$config_dir/mediaelch.yml"
...
services:
  mediaelch:
    ...
    environment:
      ...
      - TZ=Etc/UTC
    volumes:
      - $container_dir/mediaelch/config:/config
    ports:
      - 3000:3000
      - 3001:3001
...
EOL
    ...
    echo "Docker Compose-Datei für MediaElch erstellt."
else
    echo "Die Docker Compose-Datei für MediaElch existiert bereits."
fi
...
service_file="/etc/systemd/system/mediaelch-setup.service"
...
sudo systemctl enable mediaelch-setup.service
sudo systemctl start mediaelch-setup.service

echo "MediaElch wurde installiert und gestartet."
