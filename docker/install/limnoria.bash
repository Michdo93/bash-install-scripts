...
# Compose-Datei
compose_file="$config_dir/limnoria.yml"

# Service-Datei
service_file="/etc/systemd/system/limnoria-setup.service"
...
services:
  limnoria:
    ...
    environment:
      ...
      - TZ=Etc/UTC
    volumes:
      - $container_dir/limnoria/config:/config
    ports:
      - "$available_port:8080"
...
sudo systemctl enable limnoria-setup.service
sudo systemctl start limnoria-setup.service

echo "Limnoria wurde installiert und gestartet."
