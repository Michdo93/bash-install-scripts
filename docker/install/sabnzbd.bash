...
# Überprüfen, ob sabnzbd bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^sabnzbd$"; then
    echo "sabnzbd ist bereits installiert."
else
    # sabnzbd Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die sabnzbd Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für sabnzbd existiert bereits: $compose_file"
    fi
