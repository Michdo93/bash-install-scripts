...
# Compose-Datei
compose_file="$config_dir/ldap-auth.yml"

# Service-Datei
service_file="/etc/systemd/system/ldap-auth.service"
...
sudo systemctl enable ldap-auth.service
sudo systemctl start ldap-auth.service

echo "LDAP Auth wurde installiert und gestartet."
