...
compose_file="$config_dir/hishtory-server.yml"
...
EOL
    ...
    echo "Docker Compose-Datei für Hishtory Server erstellt."
else
...
service_file="/etc/systemd/system/hishtory-server.service"
cat > "$service_file" <<EOL
[Unit]
Description=Hishtory Server
...
sudo systemctl enable hishtory-server.service
sudo systemctl start hishtory-server.service
