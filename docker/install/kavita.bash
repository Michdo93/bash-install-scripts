...
config_dir="/path/to/appdata/config"
...
compose_file="$config_dir/kavita.yml"
...
EOL
    ...
    echo "Docker Compose-Datei für Kavita erstellt."
else
...
service_file="/etc/systemd/system/kavita-setup.service"
...
sudo systemctl enable kavita-setup.service
sudo systemctl start kavita-setup.service

echo "Installation und Konfiguration von Kavita abgeschlossen."
