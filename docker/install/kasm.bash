...
# Compose-Datei
compose_file="$config_dir/kasm.yml"

# Service-Datei
service_file="/etc/systemd/system/kasm.service"
...
EOL
    ...
    echo "Docker Compose-Datei für Kasm erstellt."
else
...
sudo systemctl enable kasm.service
sudo systemctl start kasm.service
