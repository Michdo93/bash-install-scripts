...
# Compose-Datei
compose_file="$config_dir/gimp.yml"

# Service-Datei
service_file="/etc/systemd/system/gimp.service"
...
run_command "mkdir -p $container_dir/gimp/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für GIMP erstellt."
else
...
sudo systemctl enable gimp.service
sudo systemctl start gimp.service
