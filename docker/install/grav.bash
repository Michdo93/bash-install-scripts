...
# Compose-Datei
compose_file="$config_dir/grav.yml"

# Service-Datei
service_file="/etc/systemd/system/grav.service"
...
run_command "mkdir -p $container_dir/grav/config" "$sudo_available"
...
EOL
    ...
    echo "Docker Compose-Datei für Grav erstellt."
else
...
sudo systemctl enable grav.service
sudo systemctl start grav.service
