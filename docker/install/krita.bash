...
# Compose-Datei
compose_file="$config_dir/krita.yml"

# Service-Datei
service_file="/etc/systemd/system/krita.service"
...
sudo systemctl enable krita.service
sudo systemctl start krita.service

echo "Krita wurde installiert und gestartet."
