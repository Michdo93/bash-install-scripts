...
# Compose-Datei
compose_file="$config_dir/thelounge.yml"

# Service-Datei
service_file="/etc/systemd/system/thelounge.service"
...
# Überprüfen, ob The Lounge bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^thelounge$"; then
    echo "The Lounge ist bereits installiert."
else
    # The Lounge Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die The Lounge Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für The Lounge existiert bereits: $compose_file"
    fi
fi
