...
# Compose-Datei
compose_file="$config_dir/raneto.yml"

# Service-Datei
service_file="/etc/systemd/system/raneto.service"
...
# Überprüfen, ob Raneto bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^raneto$"; then
    echo "Raneto ist bereits installiert."
else
    # Raneto Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die Raneto Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei an Ihre Bedürfnisse an: $compose_file"
    else
        echo "Die Raneto Docker Compose-Datei existiert bereits: $compose_file"
    fi
fi
