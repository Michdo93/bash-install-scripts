...
# Compose-Datei
compose_file="$config_dir/sickchill.yml"

# Service-Datei
service_file="/etc/systemd/system/sickchill.service"
...
# Überprüfen, ob SickChill bereits installiert ist
if docker ps -a --format '{{.Names}}' | grep -q "^sickchill$"; then
    echo "SickChill ist bereits installiert."
else
    # SickChill Docker Compose-Datei erstellen
...
EOL
        ...
        echo "Die SickChill Docker Compose-Datei wurde erstellt. Bitte passen Sie die Datei nach Bedarf an."
    else
        echo "Die Docker Compose-Datei für SickChill existiert bereits: $compose_file"
    fi
